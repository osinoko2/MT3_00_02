...
Matrix4x4 Subtract(const Matrix4x4& m1, const Matrix4x4& m2);//減算
...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	while (Novice::ProcessMessage() == 0) {
		...
		MatrixScreenPrintf(kColumnWidth * 5, kColumnWidth * 5, transposeM2);
		MatrixScreenPrintf(kColumnWidth * 5, kColumnWidth * 5 * 2, identity);
